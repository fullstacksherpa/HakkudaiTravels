        ...
        <div className="footer_style__one bg-center bg-cover bg-no-repeat mt-17 pt-17 bg-fixed overflow-hidden" style={{ background: `linear-gradient( rgba(1, 8, 11, .8)9%, rgba(8, 8, 11, .8)9%), url("${FooterDataOne.bgImg}")` }}>
          ...
          <p>TRAVELS </p>
                ...
                <div className="grid lg:grid-cols-12 lg:pt-17 pt-10 gap-base lg:pb-17 pb-12 gradient-border-top">
                    ...
                    <p className="text-white text-opacity-60 mt-[0.4rem]">IMPORTANT: We cannot be held responsible for fun overloads or
          cases of extreme sadness on returning home after one of our trips.</p>
                    </div>
                    <div className="lg:col-span-8 col-span-12 gap-base flex lg:flex-nowrap flex-wrap text-center lg:text-start lg:justify-between justify-center lg:pl-8">
                        <div className="flex-grow">
                            <div className="mb-base">
                                <h3 className="text-white lg:text-[25px] text-2md font-semibold lg:leading-1.35">Quick Links</h3>
                            </div>
                        ...
                        <div className="flex-grow">
                            <div className="mb-base">
                                <h3 className="text-white lg:text-[25px] text-2md font-semibold lg:leading-1.35">Feature Tours
                                </h3>
                            </div>
                            <ul className="footer-link-list">
                        ...
                        <div className="max-w-[275px] flex-grow shrink-0 ">
                            ...
                            <ul>
                                ...
                                <li className="mt-5 first:mt-0 flex items-center lg:justify-start justify-center text-stock-1 hover:text-primary-1 duration-200">
                                    ...
                                    <Link href={`tel:${FooterDataOne.phone2}`} className="leading-1.5 pl-[10px] text-base ">
                                        {FooterDataOne.phone2}
                                    </Link>
                                </li>
                                <li className="mt-5 first:mt-0 flex items-center lg:justify-start justify-center text-stock-1 hover:text-primary-1 duration-200">
                                    <div className="text-primary-1 shrink-0">
                ...
                <div className="text-dark-6 flex gap-4 flex-wrap lg:justify-between justify-center gradient-border-top py-7 relative">
                    ...
                    <p><Link href="https://fullstacksherpa.tech">Website developed by <span className="hover:text-purple-500 duration-200 underline">fullstacksherpa</span></Link></p>
                </div>
            </div>
        </div>
    );
