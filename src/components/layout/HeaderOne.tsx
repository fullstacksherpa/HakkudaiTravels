...
const HeaderOne = ({ variant = "default" }: { variant?: "default" | "transparent" | "transparent-V2" }) => {
    ...
    <header
            ...
            <ul className="flex items-center nav-list">
              ...
              <li className="group/step-one">
                ...
                <ul className="nav-dropdown">
                  ...
                  <li>
                    <Link href="/package-details">Package Details - Layout I</Link>
                  </li>
                  <li>
                    <Link href="/package-details-2">Package Details - Layout II</Link>
                  </li>
                </ul>
              </li>
              <li>
      ...
      <div className="mobile-menu xl:hidden flex justify-between items-center relative">
        ...
        <div id="mobile-menu" className={`mobil-menu ${toggle ? "mm-active" : ""}`}>
          <ul>
            <li className="group/step-one">
              <Link href="#" className="nav-link nav-link-sm has-dropdown " onClick={ToggleSubMenu}>
                Home
              </Link>
