...
const HeroThree = () => {
    return (
        <>
            <Parallax
                bgImage={'/assets/images/oldone/pokhara.webp'}
                strength={-150}
            ...
            >
                <div className="lg:pb-40 pb-24 lg:pt-[260px] pt-48 relative z-3">
                    <div className="container">
                        <div className="max-w-[900px] mx-auto text-center text-white">
                            <h1 className="xl:text-7xl lg:text-4xl text-3xl font-semibold leading-1.2 hero-glow-text">Experience Nepal</h1>
